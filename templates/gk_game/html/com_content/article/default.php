		...
		<meta itemprop="inLanguage" content="<?php echo ($this->item->language === '*') ? JFactory::getConfig()->get('language') : $this->item->language; ?>" />
          ...
          <header>
                    ...
                    <ul>
                              ...
                              <li class="created"><time datetime="<?php echo JHtml::_('date', $this->item->created, JText::_(DATE_W3C)); ?>"  itemprop="dateCreated"><?php echo JHtml::_('date', $this->item->created, 'F j, Y'); ?></time>
                              </li>
                              <?php endif; ?>
